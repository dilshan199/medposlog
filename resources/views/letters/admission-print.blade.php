...
<body class="bg-gray-800">
    ...
    <div class="print-page" style="background: #fff;width: 604.72px;height: 774.80px;margin: 0 auto;margin-top: 5px;padding: 37.79px 37.79px 37.79px 56.69px;">
        ...
        <div style="width: 100%;line-height: 1.5;margin-top: 5px;">
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">Medical officer - admission</p>
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">{{ session('cubical') }}</p>
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">Dear Doctor,</p>
            <p style="font-size: 14px;font-family:Arial, sans-serif;font-weight: 600;margin-top: 5px;">{{ session('admission_title')}} {{ session('admission_name') }} {{ session('admission_age') }} years, {{ session('admission_address') }}</p>
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">Please be kind enough to admit this patient for investigations and management.</p>
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">
                @php
                    echo str_replace(array("\r\n", "\r", "\n"), '<br>', session('admission_problem'))
                @endphp
            </p>
        </div>
