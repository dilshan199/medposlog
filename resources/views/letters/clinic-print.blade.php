...
<body class="bg-gray-800">
    ...
    <div class="print-page" style="background: #fff;width: 604.72px;height: 774.80px;margin: 0 auto;margin-top: 5px;padding: 37.79px 37.79px 37.79px 56.69px;">
        ...
        <div class="mt-2" style="width: 100%;line-height: 1.5;">
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">{{ session('whom') }}</p>
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">To whom it may concern,</p>
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;margin-top: 5px;">Please be kind enough to arrange needfull to the bearer, having following details.</p>
        </div>
        <div class="w-full mt-[2px]" style="line-height: 1.5;">
            <p style="font-size: 14px;font-family:Arial, sans-serif;font-weight: 600;">{{ session('clinic_title') }} {{ session('clinic_name') }} {{ session('clinic_age') }} years, {{ session('address') }}</p>
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">NIC /PP no&nbsp;&nbsp;{{ session('clinic_nic') }}</p>
        </div>
        <div style="width: 100%;margin-top: 15px;">
            ...
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">
                @php
                    echo str_replace(array("\r\n", "\r", "\n"), '<br>', session('clinic_problem'))
                @endphp
            </p>
        </div>
        <div style="width: 100%;margin-top: 15px;">
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">Recommendations /Suggestions on medical background,</p>
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">{{ session('background') }}</p>
        </div>
