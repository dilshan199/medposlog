...
<body class="bg-gray-800">
    ...
    <div class="print-page" style="background: #fff;width: 604.72px;height: 774.80px;margin: 0 auto;margin-top: 5px;padding: 37.79px 37.79px 37.79px 56.69px;">
        ...
        <div class="" style="width: 100%">
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;text-align:left;">Date: @php echo Carbon::now('Asia/Colombo')->format('Y-m-d'); @endphp</p>
        </div>
        <div style="width: 100%;line-height: 1.5;margin-top: 10px;">
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;text-decoration:underline;">To whom it may concern,</p>
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;margin-bottom: 15px;">{{ session('leave_n') }}</p>
            <p style="font-size: 14px;font-family:Arial, sans-serif;font-weight: 600;">{{ session('leave_title') }} {{ session('leave_name') }} {{ session('leave_age') }} years, {{ session('leave_address') }}</p>
        </div>
        <div class="w-full" style="line-height: 1.5;">
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">has taken treatment and recommends medical leaves</p>
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">From&nbsp;&nbsp;{{ session('from') }}</p>
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">To&nbsp;&nbsp;{{ session('to') }}</p>
        </div>
        <div style="width: 100%;margin-top: 15px;">
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">Medical problem,</p>
            <p style="font-size: 12px;font-family:Arial, sans-serif;font-weight: 600;">
                @php
                    echo str_replace(array("\r\n", "\r", "\n"), '<br>', session('leave_problem'))
                @endphp
            </p>
        </div>
